...
namespace AplicatieLicenta.Migrations
{
    ...
    [Migration("20250410131659_AdaugareQuizSiAvatar")]
    partial class AdaugareQuizSiAvatar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AplicatieLicenta.Models.Avatar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AplicatieLicenta.Models.PiesaAvatar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PieseAvatar");
                });

            modelBuilder.Entity("AplicatieLicenta.Models.PiesaDeblocata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DataDeblocare")
                        .HasColumnType("datetime2");

                    b.Property<int>("PiesaAvatarId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PiesaAvatarId");

                    b.HasIndex("UtilizatorIdUtilizator");

                    b.ToTable("PieseDeblocate");
                });
            ...
            modelBuilder.Entity("AplicatieLicenta.Models.PiesaAvatar", b =>
                {
                    b.HasOne("AplicatieLicenta.Models.Avatar", "Avatar")
                        .WithMany("Piese")
            ...
            modelBuilder.Entity("AplicatieLicenta.Models.PiesaDeblocata", b =>
                {
                    b.HasOne("AplicatieLicenta.Models.PiesaAvatar", "PiesaAvatar")
                        .WithMany()
                        .HasForeignKey("PiesaAvatarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
