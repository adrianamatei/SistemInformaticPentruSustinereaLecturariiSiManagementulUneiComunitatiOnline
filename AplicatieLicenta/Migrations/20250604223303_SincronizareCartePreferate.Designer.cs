...
namespace AplicatieLicenta.Migrations
{
    ...
    [Migration("20250604223303_SincronizareCartePreferate")]
    partial class SincronizareCartePreferate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CartePreferata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CartePreferata", b =>
                {
                    b.HasOne("AplicatieLicenta.Models.Carti", "Carte")
                        .WithMany("FavoriteDeUtilizatori")
                        .HasForeignKey("IdCarte")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AplicatieLicenta.Models.Carti", b =>
                {
                    b.Navigation("FavoriteDeUtilizatori");
